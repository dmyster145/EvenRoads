...
// Keep scroll filtering light, but firm enough to collapse duplicate callbacks generated by
...
function mapEventType(eventType: number | undefined | null): InputAction | null {
  switch (eventType) {
    case OsEventTypeList.SCROLL_TOP_EVENT:
      // Observed in HoppyRoads: this gesture should strafe right.
      if (shouldDropScroll("down")) return null;
      return "move_right";
    case OsEventTypeList.SCROLL_BOTTOM_EVENT:
      // Observed in HoppyRoads: this gesture should strafe left.
